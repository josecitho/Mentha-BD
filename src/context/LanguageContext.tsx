...
const translations = {
  ...
  es: {
    ...
    'about.subtitle': 'Durante más de una década, MENTHA SALÓN se ha construido como un espacio dedicado al cuidado personal desde una mirada fresca, consciente y emocional. Más que servicios estéticos, ofrecemos una experiencia integral donde cada clienta se siente escuchada, valorada y renovada, integrando belleza, bienestar y autenticidad en cada visita.',
    'about.story.title': 'Nuestra Historia',
    'about.story.p1': 'MENTHA SALÓN nace como un santuario de autocuidado, creado con el propósito de ofrecer mucho más que servicios de belleza. Desde el inicio, nuestra intención ha sido construir un lugar donde cada mujer pueda hacer una pausa, reconectar consigo misma y salir sintiéndose más segura y renovada.',
    'about.story.p2': 'Nuestra misión es brindar una experiencia transformadora que combine servicios estéticos de alta calidad con una atención cercana, empática y consciente. Cada detalle —desde la recepción hasta el último toque de cada servicio— está pensado para que te sientas escuchada, acompañada y respetada en tu identidad.',
    'about.story.p3': 'Nuestra visión es consolidarnos como un referente en belleza integral en la Región de Valparaíso, reconocidos por ofrecer un ambiente fresco, profesional y emocionalmente positivo. Queremos ser elegidos por quienes valoran la autenticidad, la estética con propósito y el bienestar personal como parte de su estilo de vida. El nombre "Mentha" se inspira en la planta menta, reconocida por sus propiedades refrescantes y revitalizantes. Representa la esencia del salón: un respiro para reconectar contigo misma, refrescar tu energía y vivir la belleza como una experiencia ligera, natural y llena de bienestar. Nuestro eslogan resume lo que buscamos en cada visita: "Refresca tu cuerpo y tu alma".',
    ...
    'about.values.subtitle': 'Los principios que guían todo lo que hacemos en MENTHA SALÓN se basan en el autocuidado consciente, la honestidad y el vínculo real con cada clienta. Estos son los valores que sostienen nuestra experiencia de belleza integral.',
    'about.values.clientCare': 'Frescura',
    'about.values.clientCareDesc': 'Reflejamos ligereza, renovación y calma en cada servicio y en nuestro entorno. Queremos que cada visita se sienta como un respiro para tu cuerpo y tu mente.',
    'about.values.excellence': 'Profesionalismo',
    'about.values.excellenceDesc': 'Elevamos la calidad de cada servicio mediante técnicas especializadas, formación constante y el uso de productos de primer nivel, respetando siempre tu salud y bienestar.',
    'about.values.expertTeam': 'Cercanía',
    'about.values.expertTeamDesc': 'Nos relacionamos desde la confianza y el respeto, generando un vínculo real con cada clienta. Escuchamos tus necesidades para crear una experiencia personalizada.',
    'about.values.luxury': 'Cuidado consciente',
    'about.values.luxuryDesc': 'Cada atención es una pausa intencionada para tu bienestar físico y emocional. Te acompañamos en un proceso de autocuidado que va más allá de lo estético.',
    ...
    'about.team.ana.bio': 'Con más de una década de experiencia, Ana es la fundadora de MENTHA SALÓN y experta en diseño y coloración de cabello. Su pasión es transformar la imagen de cada clienta respetando su esencia y estilo personal.',
    'about.team.sofia.bio': 'Sofia es nuestra especialista en tratamientos faciales y bienestar. Con 8 años de experiencia, se dedica a cuidar la salud de tu piel con técnicas profesionales y productos de alta calidad.',
    'about.team.lucia.bio': 'Experta en extensiones de pestañas y maquillaje profesional, Lucia aporta creatividad y precisión en cada servicio. Con 6 años de trayectoria, se especializa en realzar la belleza natural de cada mirada.',
    'about.team.carmen.bio': 'Carmen es nuestra talentosa estilista junior especializada en cortes y peinados. Con 3 años de experiencia, aporta frescura y técnicas modernas a cada servicio.',
    'about.journey.title': 'Nuestro Recorrido',
    'about.journey.subtitle': 'Una década de crecimiento, aprendizaje y transformaciones',
    'about.visit.title': 'Visítanos',
    'about.visit.subtitle': 'Ven a conocer nuestro espacio y descubre la experiencia MENTHA',
    'about.visit.location': 'Ubicación',
    'about.visit.hours': 'Horario',
    'about.visit.cta.title': '¿Lista para tu Transformación?',
    'about.visit.cta.subtitle': 'Reserva tu cita y vive la experiencia completa',
